...
public class ImageView implements INode {
	...
	public ImageView(Image image, ELayerZ eLayerZ, Object object) {
		...
		if (object instanceof IEventHandlerAble)
			setEventHandler((IEventHandlerAble) object);
	...
	private void setEventHandler(IEventHandlerAble object) {
		...
		this.imageView.setOnMouseExited(
				new EventHandler(() -> this.eventHandlerAble.handleMouseExited()));

		this.imageView.setOnMouseDragged(
				new EventHandler(() -> this.eventHandlerAble.handleMouseDragged()));

		this.imageView.setOnMouseReleased(
				new EventHandler(() -> this.eventHandlerAble.handleMouseReleased()));
	...
	public ImageView getImageViewClone() {

		if (this.imageViewClone == null) {

			this.imageViewClone = new ImageView(this.imageFront, ELayerZ.DEFAULT, this);
